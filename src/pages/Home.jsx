		...
		<main>
			...
			<section id="about" className="section">
				<div className="container">
					<h2>About Me</h2>
					<p>
						I am a second-year Computer Science Engineering student at Sri Eshwar College of Engineering with a CGPA of 8.4.
					</p>
					<p>
						I have a strong interest in Machine Learning, Data Analytics, and Generative AI. I enjoy working on real-world
						datasets, building models, and extracting meaningful insights.
					</p>
					<p>
						I completed an internship in Data Analytics &amp; AI at NIELIT, Calicut, where I worked on sentiment analysis using
						real-world news data.
					</p>
					<p>
						I believe in learning by doing — solving problems, building projects, and continuously improving my technical
						foundation.
					</p>
				</div>
			</section>
				...
				<div className="container">
					...
					<div className="grid three-col">
						<article className="card">
							<h3>Programming</h3>
							<p>C, C++, Python, Java (Beginner)</p>
						</article>
						<article className="card">
							<h3>AI / Data</h3>
							<p>Machine Learning Basics, Data Preprocessing, Sentiment Analysis</p>
						</article>
						<article className="card">
							<h3>Web &amp; Database</h3>
							<p>HTML, CSS, JavaScript (Basics), MongoDB, MySQL</p>
						</article>
						<article className="card">
							<h3>Tools</h3>
							<p>VS Code, GitHub, Figma, Canva, WordPress, Google Colab</p>
						</article>
					</div>
				</div>
			</section>
				...
				<div className="container">
					...
					<div className="grid two-col">
						<article className="card">
							...
							<p><strong>Tech Stack:</strong> Python, Pandas, Machine Learning, Web Scraping</p>
							<p>
						...
						<article className="card">
							...
							<p><strong>Tech Stack:</strong> Python, Django, MongoDB, HTML, CSS</p>
							<p>
			...
			<section id="coding-profiles" className="section alt">
				<div className="container">
